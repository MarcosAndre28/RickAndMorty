...
class CharactersAdapter(private val listener: CharacterItemListener) :
    ...
    private val items = ArrayList<InfoCharacter>()

    fun setItems(items: ArrayList<InfoCharacter>) {
        this.items.clear()
...
class CharacterViewHolder(
    ...
    private lateinit var character: InfoCharacter

    init {
        itemBinding.root.setOnClickListener(this)
    }

    fun bind(item: InfoCharacter) {
        this.character = item
